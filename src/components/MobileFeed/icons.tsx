...
const brand = { viewBox: '0 0 24 24', width: 18, height: 18, fill: 'currentColor', 'aria-hidden': true };

/** GitHub mark (Octocat) — official simple-icons path. */
...
/** LinkedIn mark — official simple-icons path. */
